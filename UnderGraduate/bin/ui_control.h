...
public:
    ...
    void setupUi(QMainWindow *Control)
    {
        ...
        lbl_status->setGeometry(QRect(480, 560, 111, 21));
        ...
        btn_temp_end->setGeometry(QRect(700, 510, 130, 30));
        ...
        sld_open->setGeometry(QRect(200, 440, 301, 19));
        ...
        lbl_open_show->setGeometry(QRect(510, 440, 81, 21));
        ...
        sld_ratio->setGeometry(QRect(200, 470, 301, 19));
        ...
        btn_duty->setGeometry(QRect(590, 440, 90, 30));
        ...
        lbl_status_pic->setGeometry(QRect(590, 550, 28, 28));
        ...
        lbl_ratio_show->setGeometry(QRect(510, 470, 81, 21));
        ...
        sld_x_scale->setGeometry(QRect(40, 405, 541, 19));
        ...
        sld_y_center->setGeometry(QRect(790, 50, 20, 141));
        ...
        graphFrame->setGeometry(QRect(50, 40, 631, 150));
        ...
        btn_open->setGeometry(QRect(590, 475, 90, 30));
        ...
        lbl_x_present->setGeometry(QRect(600, 400, 61, 21));
        ...
        btn_temp_pause->setGeometry(QRect(700, 475, 130, 30));
        ...
        lbl_ratio->setGeometry(QRect(10, 470, 191, 21));
        ...
        btn_temp_start->setGeometry(QRect(700, 440, 130, 30));
        ...
        lbl_y_min->setGeometry(QRect(690, 170, 61, 21));
        ...
        btn_close->setGeometry(QRect(590, 510, 90, 30));
        ...
        lbl_y_mid->setGeometry(QRect(690, 100, 61, 21));
        ...
        lbl_time0->setGeometry(QRect(700, 560, 41, 21));
        ...
        lbl_real_t->setGeometry(QRect(10, 525, 91, 31));
        ...
        lbl_di->setGeometry(QRect(330, 560, 91, 21));
        ...
        lbl_di_pic->setGeometry(QRect(420, 550, 28, 28));
        ...
        lbl_y_max_2->setGeometry(QRect(690, 230, 61, 21));
        ...
        lbl_temp_2->setGeometry(QRect(330, 190, 141, 41));
        ...
        graphFrame_2->setGeometry(QRect(50, 230, 631, 150));
        ...
        sld_y_center_2->setGeometry(QRect(790, 240, 20, 141));
        sld_y_center_2->setMaximum(100);
        sld_y_center_2->setValue(50);
        ...
        lbl_center_2->setGeometry(QRect(610, 200, 141, 21));
        ...
        lbl_y_min_2->setGeometry(QRect(690, 360, 61, 21));
        ...
        lbl_center_show_2->setGeometry(QRect(740, 200, 81, 21));
        ...
        lbl_y_mid_2->setGeometry(QRect(690, 290, 61, 21));
        ...
        listWidget_2->setGeometry(QRect(100, 560, 210, 25));
