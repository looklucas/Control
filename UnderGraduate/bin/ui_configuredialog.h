...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        ConfigureDialog->resize(456, 311);
        ConfigureDialog->setMinimumSize(QSize(456, 311));
        ConfigureDialog->setMaximumSize(QSize(456, 311));
        cmbDevice = new QComboBox(ConfigureDialog);
        cmbDevice->setObjectName(QStringLiteral("cmbDevice"));
        cmbDevice->setGeometry(QRect(110, 20, 251, 20));
        ...
        lblDevice->setGeometry(QRect(30, 20, 61, 16));
        ...
        lblValueRange->setGeometry(QRect(14, 84, 121, 22));
        ...
        cmbChannelCount->setGeometry(QRect(160, 52, 201, 20));
        ...
        lblDevice_2->setGeometry(QRect(30, 60, 71, 20));
